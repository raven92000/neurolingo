      ...
      <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                ...
                <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '16px', fontWeight: '800', color: '#F59E0B' }}>
                  {streak}
                </span>
              </div>
              <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '9px', color: 'rgba(245,158,11,0.6)' }}>
                jours de série
              </span>
            </div>
            ...
            <div style={{
              ...
              <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '16px', fontWeight: '800', color: '#8B5CF6' }}>
                {xp} XP
              </span>
            </div>
          </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            color: 'rgba(139,92,246,0.8)', margin: 0,
          }}>
            Ta leçon t'attend
          </p>
        </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              <p style={{
                ...
                color: 'rgba(167,139,250,0.7)', margin: '0 0 4px',
              ...
              <p style={{
                ...
                fontWeight: '900', color: '#FFFFFF', margin: '0 0 5px',
              }}>
                Les salutations
              </p>
              <p style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              <span style={{
                fontFamily: 'DM Sans, sans-serif', fontSize: '13px',
                color: '#58CC02', fontWeight: '600',
              }}>
                Encore {restant} XP
              </span>
              <span style={{
                fontFamily: 'DM Sans, sans-serif', fontSize: '12px',
                color: 'rgba(255,255,255,0.25)', marginLeft: '6px',
              }}>
          ...
          <div style={{
            ...
            borderRadius: '99px', overflow: 'visible',
            position: 'relative',
          }}>
            <div style={{
              width: `${(progression / objectif) * 100}%`,
              height: '100%',
              background: 'linear-gradient(90deg, #7C3AED, #58CC02)',
              borderRadius: '99px',
              position: 'relative',
            }}>
              <div style={{
                ...
                animation: 'progressStar 2s ease-in-out infinite',
              }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <p style={{
                fontFamily: 'Nunito, sans-serif', fontSize: '24px',
                fontWeight: '900', color: stat.color, margin: '0 0 4px',
              }}>
                {stat.value}
              </p>
              <p style={{
